        ...
        >
          <div className="w-full xl:w-1/2 relative">
            <h4 className="heading4">
              Vi Strävar Efter Att Alltid Ligga Steget Före
            </h4>
            <div className="bg-img mt-7 video-block relative overflow-hidden rounded-[20px]">
              <Image
                ...
                height={5000}
                className="w-full"
                src="/images/component/about3.png"
                alt="about3"
              />
              <button
              ...
              <span className="text-title text-white absolute left-5 bottom-5">
          ...
          <div className="w-full xl:w-1/2 xl:pl-20">
            <div className="bg-white sm:p-10 p-6 rounded-[20px]">
              <h3 className="heading3">
                Boka Ett Kostnadsfritt Videomöte Med Oss!
              </h3>
              <div className="list-feature mt-7">
                <div className="flex items-center">
                  <Icon.Check className="text-blue text-2xl" />
                  <div className="text-title pl-3">Grundlig Behovsanalys</div>
                </div>
                <div className="flex items-center mt-3">
                  <Icon.Check className="text-blue text-2xl" />
                  <div className="text-title pl-3">Frågor Och Rådgivning</div>
                </div>
                <div className="flex items-center mt-3">
                  <Icon.Check className="text-blue text-2xl" />
                  <div className="text-title pl-3">Prisoffert</div>
                </div>
              </div>
              <Link
                className="button-main md:mt-9 mt-7"
